...
const RiderHomeScreen = () => {
  ...
  const StatusBadge = ({ status }) => {
    ...
    const { label, color, icon } =
      statusConfig[status] || statusConfig.collecting;
        ...
        <View style={styles.header}>
          <View>
            ...
            <Text style={styles.subtitle}>
              {hasActiveOrders
                ? `${deliveryData.upcoming.length + 1} active deliveries`
                : "Ready for orders"}
            </Text>
          </View>
              ...
              <View style={styles.deliveryInfo}>
                ...
                <View style={styles.deliveryDetails}>
                  <Text style={styles.restaurantName}>
                    {deliveryData.current.restaurant}
                  </Text>
                  <Text style={styles.customerName}>
                    to {deliveryData.current.customer}
                  </Text>
                  <Text style={styles.deliveryAddress}>
                    {deliveryData.current.address}
                  </Text>
                </View>
              </View>
              ...
              <View style={styles.progressContainer}>
                ...
                <View style={styles.progressTrack}>
                  <View
                    style={[
                      styles.progressFill,
                      { width: `${deliveryData.current.progress * 100}%` },
                    ]}
                  />
                </View>
              </View>
