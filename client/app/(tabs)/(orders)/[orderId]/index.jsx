...
const OrderDetailScreen = () => {
    ...
    const {activeOrders, historicalOrders, fetchOrder, moveToHistory} = useOrders();
    ...
    // Get order from cache or fetch if missing
    ...
    const handleViewMap = () => {
        const {latitude, longitude} = order.restaurant.address.coordinates;
        ...
        <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
            ...
            {isHistoricalOrder && (
                <View style={[styles.statusBanner, {backgroundColor: colors[order.status] + '20'}]}>
                    ...
                    <Text style={[styles.statusBannerText, {color: colors[order.status]}]}>
                        {order.status} {order.cancelledAt && `• ${new Date(order.cancelledAt).toLocaleDateString()}`}
                    </Text>
                </View>
            )}
            ...
            <View style={styles.card}>
                <View style={styles.summaryRow}>
                    ...
                    <Ionicons name="time" size={20} color={colors.textSecondary} style={styles.summaryIcon}/>
                    <Text style={styles.summaryText}>
            ...
            <View style={styles.card}>
                ...
                <View style={styles.totalContainer}>r
                    <View style={styles.totalRow}>
                        <Text style={styles.totalLabel}>Subtotal</Text>
                        <Text style={styles.totalValue}>Rs{order.subtotal?.toFixed(2)}</Text>
                    </View>
                    <View style={styles.totalRow}>
                        <Text style={styles.totalLabel}>Delivery Fee</Text>
                        <Text style={styles.totalValue}>Rs{order.deliveryFee?.toFixed(2)}</Text>
                    </View>
            ...
            {!isHistoricalOrder && (
                <View style={styles.card}>
                        ...
                        {['Preparing', 'On the way', 'Delivered'].map((stage, index) => (
                            <View key={stage} style={styles.trackingStep}>
                                <View style={[
                                    ...
                                    <Ionicons
                                        name={index === 0 ? 'restaurant' : index === 1 ? 'bicycle' : 'home'}
                                        size={20}
                    ...
                    <TouchableOpacity style={styles.mapButton} onPress={handleViewMap}>
                        <Image source={images.mapPlaceholder} style={styles.mapImage} resizeMode="cover"/>
                    ...
                    <View style={styles.locationInfo}>
                        ...
                        <Text style={styles.locationText}>{order.restaurant.address.street}</Text>
                    </View>
                </View>
            )}
