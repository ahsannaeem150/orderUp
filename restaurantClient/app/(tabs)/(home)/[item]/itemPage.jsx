  ...
  return (
    <View
      style={[
        ...
        isDescription && styles.descriptionContainer,
        isName && styles.nameContainer,
      ]}
    >
      ...
      {isEditing ? (
        field === "tags" ? (
          ...
          >
            <Text>
              {currentValue
                ? dayjs(currentValue).format("MMM D, YYYY")
                : "Select date"}
            </Text>
          </TouchableOpacity>
        ) : (
        ...
        <Text
          style={[styles.fieldValue, isDescription && styles.descriptionText]}
        >
          {date
            ? editedItem[field]
              ? dayjs(editedItem[field]).format("MMM D, YYYY")
              : "N/A"
...
const ItemDetailsPage = () => {
  ...
  const { reviews, fetchReviews, reviewsLoading } = useFetchReviews(
    currentItem?._id
  );
  ...
  const toggleAvailability = async () => {
    try {
      ...
      Alert.alert(
        "Update failed",
        error.response?.data?.message || "Couldn't toggle availability"
      );
    } finally {
      setLoading(false);
    }
        ...
        <Animated.View
          style={[
            styles.progressBar,
            {
              ...
              backgroundColor:
                currentItem?.stock < currentItem?.minStock
                  ? colors.error
                  : currentItem?.stock < currentItem?.maxStock / 2
                  ? colors.highlight
                  : colors.success,
            },
          ]}
      ...
      <View style={styles.grid}>
        ...
        <View style={styles.fieldContainer}>
          ...
          <Text style={styles.fieldValue}>
            {currentItem.lastSoldDate
              ? dayjs(currentItem.lastSoldDate).format("MMM D")
              : "Never"}
          </Text>
        </View>
        <View style={styles.fieldContainer}>
        ...
        <View style={styles.fieldContainer}>
          ...
          <Text style={styles.fieldValue}>
            {Math.round(currentItem.profitMargin)}%
          </Text>
        </View>
      </View>
    </View>
    ...
    return (
      <View style={styles.discountBadge}>
        <Text style={styles.discountText}>
          {currentItem.discount}% OFF until{" "}
          {dayjs(currentItem.discountEnd).format("MMM D")}
        </Text>
      </View>
    );
  };
        ...
        <View style={styles.content}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.grid}>
              ...
              <EditableField
                label="Unit"
                field="unit"
                options={["pieces", "kg", "liters", "packets"]}
                isEditing={isEditing}
                editedItem={editedItem}
                setEditedItem={setEditedItem}
                handleRemoveTag={handleRemoveTag}
          ...
          <View style={styles.section}>
            ...
            <View style={styles.systemInfo}>
              <DetailRow
                label="Created"
                value={new Date(currentItem.createdAt).toLocaleDateString()}
              />
              <DetailRow
                label="Last Updated"
